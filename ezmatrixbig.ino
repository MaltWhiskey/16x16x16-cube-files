...
int voxelXw5[VOX_POINTS];
int voxelZw5[VOX_POINTS];
int voxelXw6[VOX_POINTS];
int voxelZw6[VOX_POINTS];
int voxelXw7[VOX_POINTS];
int voxelZw7[VOX_POINTS];
int voxelXw8[VOX_POINTS];
int voxelZw8[VOX_POINTS];
int voxDelay(150);
int wave01(15);
int wave02(21);
int wave03(31);
int wave04(41);
Color brightLine01 = Color(50, 220, 51);
Color brightLine02 = Color(45, 193, 45);
...
Color brightLine07 = Color(5, 10, 3);
Color brightLine08 = Color(2, 5, 2);
...
Color medLine06 = Color(4, 10, 3);
Color medLine07 = Color(2, 5, 2);
Color medLine08 = Color(0, 3, 0);
...
Color darkLine06 = Color(0, 6, 0);
Color darkLine07 = Color(0, 4, 0);
Color darkLine08 = Color(0, 2, 0);
...

{
  if (wave01>-18) {
    for(int i=16;i>0;i--)
      {
        setVoxel(voxelXw1[i], wave01+19, voxelZw1[i], Color(0,0,0));
        setVoxel(voxelXw1[i], wave01+18, voxelZw1[i], brightLine08);
        setVoxel(voxelXw1[i], wave01+17, voxelZw1[i], brightLine08);
        setVoxel(voxelXw1[i], wave01+16, voxelZw1[i], brightLine07);
        setVoxel(voxelXw1[i], wave01+15, voxelZw1[i], brightLine07);
        setVoxel(voxelXw1[i], wave01+14, voxelZw1[i], brightLine06);
        setVoxel(voxelXw1[i], wave01+13, voxelZw1[i], brightLine06);
        setVoxel(voxelXw1[i], wave01+12, voxelZw1[i], brightLine05);
        setVoxel(voxelXw1[i], wave01+11, voxelZw1[i], brightLine05);
        setVoxel(voxelXw1[i], wave01+10, voxelZw1[i], brightLine04);
        setVoxel(voxelXw1[i], wave01+9, voxelZw1[i], brightLine04);
        setVoxel(voxelXw1[i], wave01+8, voxelZw1[i], brightLine03);
        setVoxel(voxelXw1[i], wave01+7, voxelZw1[i], brightLine03);
        setVoxel(voxelXw1[i], wave01+6, voxelZw1[i], brightLine02);
        setVoxel(voxelXw1[i], wave01+5, voxelZw1[i], brightLine02);
        setVoxel(voxelXw1[i], wave01+4, voxelZw1[i], brightLine01);
        setVoxel(voxelXw1[i], wave01+3, voxelZw1[i], brightLine03);
        setVoxel(voxelXw1[i], wave01+2, voxelZw1[i], brightLine02);
        setVoxel(voxelXw1[i], wave01+1, voxelZw1[i], brightLine02);
        setVoxel(voxelXw1[i], wave01, voxelZw1[i], brightLine01);
      }
    wave01--;
  }
  ...
  if (wave02>-18) {
    for(int i=16;i>0;i--)
      {
        setVoxel(voxelXw2[i], wave02+19, voxelZw2[i], Color(0,0,0));
        setVoxel(voxelXw2[i], wave02+18, voxelZw2[i], medLine05);
        setVoxel(voxelXw2[i], wave02+17, voxelZw2[i], medLine04);
        setVoxel(voxelXw2[i], wave02+16, voxelZw2[i], medLine04);
        setVoxel(voxelXw2[i], wave02+15, voxelZw2[i], medLine03);
        setVoxel(voxelXw2[i], wave02+14, voxelZw2[i], medLine03);
        setVoxel(voxelXw2[i], wave02+13, voxelZw2[i], medLine02);
        setVoxel(voxelXw2[i], wave02+12, voxelZw2[i], medLine02);
        setVoxel(voxelXw2[i], wave02+11, voxelZw2[i], medLine02);
        setVoxel(voxelXw2[i], wave02+10, voxelZw2[i], medLine01);
        setVoxel(voxelXw2[i], wave02+9, voxelZw2[i], Color(0,0,0));
        setVoxel(voxelXw2[i], wave02+8, voxelZw2[i], medLine05);
        setVoxel(voxelXw2[i], wave02+7, voxelZw2[i], medLine04);
        setVoxel(voxelXw2[i], wave02+6, voxelZw2[i], medLine04);
        setVoxel(voxelXw2[i], wave02+5, voxelZw2[i], medLine03);
        setVoxel(voxelXw2[i], wave02+4, voxelZw2[i], medLine03);
        setVoxel(voxelXw2[i], wave02+3, voxelZw2[i], medLine02);
        setVoxel(voxelXw2[i], wave02+2, voxelZw2[i], medLine02);
        setVoxel(voxelXw2[i], wave02+1, voxelZw2[i], medLine02);
        setVoxel(voxelXw2[i], wave02, voxelZw2[i], medLine01);
      }
    wave02--;
  }
  ...
  if (wave03>-18) {
    for(int i=16;i>0;i--)
      {
        setVoxel(voxelXw3[i], wave03+19, voxelZw3[i], Color(0,0,0));
        setVoxel(voxelXw3[i], wave03+18, voxelZw3[i], darkLine05);
        setVoxel(voxelXw3[i], wave03+17, voxelZw3[i], darkLine05);
        setVoxel(voxelXw3[i], wave03+16, voxelZw3[i], darkLine04);
        setVoxel(voxelXw3[i], wave03+15, voxelZw3[i], darkLine04);
        setVoxel(voxelXw3[i], wave03+14, voxelZw3[i], darkLine04);
        setVoxel(voxelXw3[i], wave03+13, voxelZw3[i], darkLine03);
        setVoxel(voxelXw3[i], wave03+12, voxelZw3[i], darkLine03);
        setVoxel(voxelXw3[i], wave03+11, voxelZw3[i], darkLine03);
        setVoxel(voxelXw3[i], wave03+10, voxelZw3[i], darkLine03);
        setVoxel(voxelXw3[i], wave03+9, voxelZw3[i], darkLine03);
        setVoxel(voxelXw3[i], wave03+8, voxelZw3[i], darkLine02);
        setVoxel(voxelXw3[i], wave03+7, voxelZw3[i], darkLine02);
        setVoxel(voxelXw3[i], wave03+6, voxelZw3[i], darkLine02);
        setVoxel(voxelXw3[i], wave03+5, voxelZw3[i], darkLine02);
        setVoxel(voxelXw3[i], wave03+4, voxelZw3[i], darkLine01);
        setVoxel(voxelXw3[i], wave03+3, voxelZw3[i], darkLine01);
        setVoxel(voxelXw3[i], wave03+2, voxelZw3[i], darkLine01);
        setVoxel(voxelXw3[i], wave03+1, voxelZw3[i], darkLine01);
        setVoxel(voxelXw3[i], wave03, voxelZw3[i], darkLine01);
      }
    wave03--;
  }
  ...
  if (wave04>-18) {
    for(int i=16;i>0;i--)
      {
        setVoxel(voxelXw4[i], wave04+19, voxelZw4[i], Color(0,0,0));
        setVoxel(voxelXw4[i], wave04+18, voxelZw4[i], medLine05);
        setVoxel(voxelXw4[i], wave04+17, voxelZw4[i], medLine04);
        setVoxel(voxelXw4[i], wave04+16, voxelZw4[i], medLine04);
        setVoxel(voxelXw4[i], wave04+15, voxelZw4[i], medLine03);
        setVoxel(voxelXw4[i], wave04+14, voxelZw4[i], medLine03);
        setVoxel(voxelXw4[i], wave04+13, voxelZw4[i], medLine02);
        setVoxel(voxelXw4[i], wave04+12, voxelZw4[i], medLine02);
        setVoxel(voxelXw4[i], wave04+11, voxelZw4[i], medLine02);
        setVoxel(voxelXw4[i], wave04+10, voxelZw4[i], medLine01);
        setVoxel(voxelXw4[i], wave04+9, voxelZw4[i], Color(0,0,0));
        setVoxel(voxelXw4[i], wave04+8, voxelZw4[i], medLine05);
        setVoxel(voxelXw4[i], wave04+7, voxelZw4[i], medLine04);
        setVoxel(voxelXw4[i], wave04+6, voxelZw4[i], medLine04);
        setVoxel(voxelXw4[i], wave04+5, voxelZw4[i], medLine03);
        setVoxel(voxelXw4[i], wave04+4, voxelZw4[i], medLine03);
        setVoxel(voxelXw4[i], wave04+3, voxelZw4[i], medLine02);
        setVoxel(voxelXw4[i], wave04+2, voxelZw4[i], medLine02);
        setVoxel(voxelXw4[i], wave04+1, voxelZw4[i], medLine02);
        setVoxel(voxelXw4[i], wave04, voxelZw4[i], medLine01);
      }
    wave04--;
  }
