...
#define LIAB 0 //Lightening in a Box
...
void liab() //Lightening in a Box
{
  background(Color(0,0,0));
  show();
  

  Point p1 = { rand()%SIZE, SIZE-1, rand()%SIZE };
  Point p2 = { rand()%SIZE, rand()%3, rand()%SIZE };
  Point p3 = { rand()%4-2+p2.x, 0, rand()%4-2+p2.z };
  Point p4 = { rand()%4-2+p2.x, 0, rand()%4-2+p2.z };
  Point p5 = { rand()%4-2+p2.x, 0, rand()%4-2+p2.z };
  Point p6 = { rand()%4-2+p2.x, 0, rand()%4-2+p2.z };
  ...
  clr[2] = Color(0, 0, 4);
  clr[3] = Color(0, 0, 0);
  clr[4] = Color(128, 128, 128);
  clr[5] = Color(0, 0, 2);
  clr[6] = Color(200,200,200);
  clr[7] = Color(0, 0, 4);
  clr[8] = Color(0, 0, 2);
